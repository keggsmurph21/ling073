...
pkgdatadir = $(datadir)/apertium-kam
pkgincludedir = $(includedir)/apertium-kam
pkglibdir = $(libdir)/apertium-kam
pkglibexecdir = $(libexecdir)/apertium-kam
...
CONFIG_CLEAN_FILES = apertium-kam.pc
...
am__installdirs = "$(DESTDIR)$(apertium_kamdir)" \
	"$(DESTDIR)$(pkgconfigdir)"
DATA = $(apertium_kam_DATA) $(noinst_DATA) $(pkgconfig_DATA)
am__tagged_files = $(HEADERS) $(SOURCES) $(TAGS_FILES) $(LISP)
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/apertium-kam.pc.in \
...
ACLOCAL = ${SHELL} /Users/user/work/apertium/dicts/ling073-kam/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
APERTIUM_CFLAGS = -I/usr/local/include/apertium-3.4 -I/usr/local/lib/apertium-3.4/include -I/usr/local/include/lttoolbox-3.3 -I/usr/local/lib/lttoolbox-3.3/include -I/opt/local/include/libxml2 -I/opt/local/include
APERTIUM_LIBS = -L/usr/local/lib -L/opt/local/lib -lapertium3 -llttoolbox3 -lxml2 -lpcre
AUTOCONF = ${SHELL} /Users/user/work/apertium/dicts/ling073-kam/missing autoconf
AUTOHEADER = ${SHELL} /Users/user/work/apertium/dicts/ling073-kam/missing autoheader
AUTOMAKE = ${SHELL} /Users/user/work/apertium/dicts/ling073-kam/missing automake-1.15
AWK = gawk
CGCOMP = /usr/local/bin/cg-comp
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"Apertium\ Kamba\" -DPACKAGE_TARNAME=\"apertium-kam\" -DPACKAGE_VERSION=\"0.1.0\" -DPACKAGE_STRING=\"Apertium\ Kamba\ 0.1.0\" -DPACKAGE_BUGREPORT=\"kmurphy4@swarthmore.edu\" -DPACKAGE_URL=\"http://wiki.apertium.org/wiki/Apertium-kam\" -DPACKAGE=\"apertium-kam\" -DVERSION=\"0.1.0\"
ECHO_C = \c
ECHO_N = 
ECHO_T = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Users/user/work/apertium/dicts/ling073-kam/missing makeinfo
MKDIR_P = ./install-sh -c -d
PACKAGE = apertium-kam
PACKAGE_BUGREPORT = kmurphy4@swarthmore.edu
PACKAGE_NAME = Apertium Kamba
PACKAGE_STRING = Apertium Kamba 0.1.0
PACKAGE_TARNAME = apertium-kam
PACKAGE_URL = http://wiki.apertium.org/wiki/Apertium-kam
...
STRIP = 
VERSION = 0.1.0
abs_builddir = /Users/user/work/apertium/dicts/ling073-kam
abs_srcdir = /Users/user/work/apertium/dicts/ling073-kam
abs_top_builddir = /Users/user/work/apertium/dicts/ling073-kam
abs_top_srcdir = /Users/user/work/apertium/dicts/ling073-kam
am__leading_dot = .
...
install_sh = ${SHELL} /Users/user/work/apertium/dicts/ling073-kam/install-sh
...
###############################################################################
#
#   apertium_kam_dir: This is where the compiled binaries go
#   apertium_kam_srcdir: This is where the source files go
apertium_kamdir = $(prefix)/share/apertium/$(BASENAME)/
apertium_kam_srcdir = $(prefix)/share/apertium/$(BASENAME)/
EXTRA_TARGETS = $(am__append_1)
apertium_kam_DATA = $(TARGETS_COMMON) $(EXTRA_TARGETS)
...
$(am__aclocal_m4_deps):
apertium-kam.pc: $(top_builddir)/config.status $(srcdir)/apertium-kam.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
install-apertium_kamDATA: $(apertium_kam_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_kam_DATA)'; test -n "$(apertium_kamdir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_kamdir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_kamdir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_kamdir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_kamdir)" || exit $$?; \
	done

uninstall-apertium_kamDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_kam_DATA)'; test -n "$(apertium_kamdir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_kamdir)'; $(am__uninstall_files_from_dir)
...
installdirs:
	for dir in "$(DESTDIR)$(apertium_kamdir)" "$(DESTDIR)$(pkgconfigdir)"; do \
...
install-data-am: install-apertium_kamDATA install-data-local \
...
uninstall-am: uninstall-apertium_kamDATA uninstall-pkgconfigDATA
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	install install-am install-apertium_kamDATA install-data \
	...
	uninstall-am uninstall-apertium_kamDATA \
	uninstall-pkgconfigDATA
...
install-data-local: install-modes
	test -d $(DESTDIR)$(apertium_kam_srcdir) || mkdir -p $(DESTDIR)$(apertium_kam_srcdir)
	$(INSTALL_DATA) $(BASENAME).$(LANG1).lexc $(DESTDIR)$(apertium_kam_srcdir)
	$(INSTALL_DATA) $(BASENAME).$(LANG1).twol $(DESTDIR)$(apertium_kam_srcdir)
	$(INSTALL_DATA) $(BASENAME).$(LANG1).rlx $(DESTDIR)$(apertium_kam_srcdir)
	$(INSTALL_DATA) $(BASENAME).post-$(LANG1).dix $(DESTDIR)$(apertium_kam_srcdir)
clean-local:
	-rm -rf .deps modes
...
test: all
	echo "TODO test sentence" | apertium -d . kam-morph | tee .test-mt
